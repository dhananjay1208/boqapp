      ...
      if (editingEquipment) {
        ...
        const { error } = await supabase
          ...
          .insert({
            name: formData.name.trim(),
            description: formData.description.trim() || null,
            hourly_rate: 0, // Default rate, actual rates defined in Equipment Rates
          })
          ...
          <CardHeader>
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <CardDescription>
                  Manage equipment types (JCB, Roller, Crane, etc.). Define rates in Equipment Rates page.
                </CardDescription>
              </div>
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {editingEquipment
                ...
                : 'Add a new equipment type. Define rates per supplier in Equipment Rates.'}
            </DialogDescription>
          </DialogHeader>
